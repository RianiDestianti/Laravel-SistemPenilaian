...
<div class="container">
    ...
    <div class="page-header">
        <h1><i class="fas fa-users me-2"></i> Daftar User</h1>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('user.create') }}" class="btn btn-primary btn-add-user">
            <i class="fas fa-plus-circle"></i> Tambah User
        </a>
        
        <div class="d-inline-block">
            <span class="badge bg-secondary px-3 py-2">Total: {{ $users->total() }} User</span>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-initial rounded-circle bg-light text-primary me-2 d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
    ...
    <div class="d-flex justify-content-center mt-4">
        {{ $users->appends(['search' => request('search'), 'role' => request('role'), 'sort_by' => request('sort_by'), 'sort_order' => request('sort_order')])->links() }}
    </div>
</div>
@endsection
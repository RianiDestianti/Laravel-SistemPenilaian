...
<div class="container">
    ...
    <div class="page-header">
        <h1><i class="fas fa-user-graduate me-2"></i> Daftar Murid</h1>
    </div>

    <!-- Filter Panel -->
    <div class="filter-panel">
        <form method="GET" action="{{ route('murid.index') }}" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-1">
                <a href="{{ route('murid.index') }}" class="btn btn-outline-danger w-100">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('murid.create') }}" class="btn btn-primary">
            <i class="fas fa-plus-circle"></i> Tambah Murid
        </a>
        
        <div class="d-inline-block">
            <span class="badge bg-secondary px-3 py-2">Total: {{ $murid->total() }} Murid</span>
        </div>
    </div>
            ...
            <table class="table">
                ...
                <tbody>
                    @forelse ($murid as $item)
                        <tr>
                            <td>{{ $murid->firstItem() + $loop->index }}</td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-initial rounded-circle bg-light text-success me-2 d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                            ...
                            <td>
                                <div class="btn-action-container">
                                    <a href="{{ route('murid.edit', $item->id) }}" class="btn btn-warning btn-action">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-empty">
                                <i class="fas fa-info-circle me-2"></i>Tidak ada data murid ditemukan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
